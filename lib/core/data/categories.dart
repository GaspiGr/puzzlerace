...
class AppCategories {
  ...
  static const List<PuzzleCategory> all = [
    PuzzleCategory(
      ...
      color: Color(0xFF40F080),
      bgColor: Color(0xFF0D2B1A),
    ),
    PuzzleCategory(
      id: 'ciudades',
      label: 'Ciudades',
      ...
      color: Color(0xFF40B0F0),
      bgColor: Color(0xFF0D1E2B),
    ),
    PuzzleCategory(
      id: 'arte',
      label: 'Arte',
      ...
      color: Color(0xFFA060F0),
      bgColor: Color(0xFF1A0D2B),
    ),
    PuzzleCategory(
      id: 'animales',
      label: 'Animales',
    ...
    PuzzleCategory(
      ...
      color: Color(0xFF60D0C0),
      bgColor: Color(0xFF0D2228),
    ),
  ];
